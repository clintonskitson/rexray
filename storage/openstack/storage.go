...
func Init(cfg *config.Config) (storage.Driver, error) {
	...
	fields["identityEndpoint"] = cfg.OpenstackAuthUrl
	fields["userId"] = cfg.OpenstackUserId
	fields["userName"] = cfg.OpenstackUserName
	if cfg.OpenstackPassword == "" {
		fields["password"] = ""
	} else {
		fields["password"] = "******"
	}
	fields["tenantId"] = cfg.OpenstackTenantId
	fields["tenantName"] = cfg.OpenstackTenantName
	fields["domainId"] = cfg.OpenstackDomainId
	fields["domainName"] = cfg.OpenstackDomainName
