...
func (c *Config) initConfigKeys() {
	...
	c.asvp(XtremIoInsecure, &c.XtremIoInsecure)
...
func initConfigKeyMap() {
	...
	keys = ConfigKeyMap{
		...
		XtremIoInsecure:     ck("GOXTREMIO_INSECURE", "", ""),
		XtremIoDeviceMapper: ck("REXRAY_XTREMIO_DM", "", ""),
		XtremIoMultipath:    ck("REXRAY_XTREMIO_MULTIPATH", "", ""),
	}
